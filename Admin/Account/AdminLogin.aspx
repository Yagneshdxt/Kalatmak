    ...
    <center>
        <table border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="lnkForgotPass" Text="Forgot Password" runat="server" OnClick="lnkForgotPass_Click" />
                    <asp:LinkButton Text="Change Login Password" runat="server" PostBackUrl="~/Admin/Account/ChangePassword.aspx" />
                </td>
            </tr>
        </table>
    </center>
